...
def main(args=None):
    ...
    # arm.set_goal_state(configuration_name="pose2")
    ...
    pose_goal.pose.position.x = 3.1
    pose_goal.pose.position.y = -0.2
    pose_goal.pose.position.z = 8.0
    pose_goal.pose.orientation.x = q_x
    pose_goal.pose.orientation.y = q_y
    pose_goal.pose.orientation.z = q_z
    pose_goal.pose.orientation.w = 1.0  # MUST be 1.0 for identity
